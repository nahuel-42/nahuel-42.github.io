<?php
    if(isset($_POST['enviar']) && empty($_POST['Email']) && !empty($_POST['empresa']) && !empty($_POST['name']) && !empty($_POST['message']) && !empty($_POST['telefono'])){
        $message = $_POST['message'];
        if ( strpos($message, '<') === false  && strpos($message, '<') === false && strpos($message, 'http://')=== false && strpos($message, 'https://')=== false && !preg_match('/[^\p{Common}\p{Latin}]/u', $message)) {
            $email = $_POST['empresa'];
            $name = $_POST['name'];
